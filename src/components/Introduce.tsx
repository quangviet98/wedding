  ...
  return (
    <div className="section" ref={sectionRef}>
      <div className="content">
        <div data-w-id="53b697f0-023e-7f03-d53c-bf4f4b3206cd" className="w-layout-grid grid-postcard">
          <div id="w-node-a38a8908-1dc6-e0b5-39a4-e35f06688720-26472350" className="postcard---block-right">
            <div className="postcard-text">
              ...
              <p className="paragraph">Cras urna sed purus magna morbi morbi congue suspendisse. Est faucibus hendrerit donec nisi, feugiat suscipit eu, sit. Orci euismod nibh.</p>
              <a href="/about/about-c" className="button w-button">more about us</a>
            </div>
          </div>
          <div
